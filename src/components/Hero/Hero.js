...
function Hero() {
    return (
        ...
        Coffee Hoyse" fontSz="70px" margin="0 0 40px 0" />
                <span><Button buttonTitle="Explore More" fontSz="16px" fontCl="#0A0B0D" padding="10px 25px" backgroundCl="#E8E8E8" border="1px #E8E8E8 solid" marginRight="15px" /></span>
